...
class TransformRequest
{
    ...
    /**
     * Create Illuminate TransformRequest.
     *
     * @param array $get
     * @param array $post
     * @param array $cookie
    ...
    protected function createIlluminateRequest($get, $post, $cookie, $files, $server, $content = null)
    {
        ...
        /*
        |--------------------------------------------------------------------------
        | Copy from \Symfony\Component\HttpFoundation\TransformRequest::createFromGlobals().
        |--------------------------------------------------------------------------
        |
    ...
    /**
     * Transformers request parameters.
     *
